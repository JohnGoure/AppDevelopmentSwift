...
let goal = 10000.0
func progressUpdate() {
    steps < (Double(goal) * 0.1) ? print("You're off to a good start") : steps < (goal / 2.0) ? print("You're almost halfway there!") : steps < (Double(goal) * 0.9) ? print("You're over halfway there!") : print("You're almost there!")
}
